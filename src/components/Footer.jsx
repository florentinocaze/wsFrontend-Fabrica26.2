    ...
    <footer className="footer">
      <div className="footer-container">
        <section className="footer-section">
          <h3>Sobre o Overwatch Heroes</h3>
        ...
        <section className="footer-section">
          ...
          <a href="https://overfast-api.tekrop.fr/" target="_blank" rel="noopener noreferrer">Overfast API</a>
          <a href="https://overwatch.blizzard.com/" target="_blank" rel="noopener noreferrer">Overwatch 2</a>
          <a href="https://www.blizzard.com/" target="_blank" rel="noopener noreferrer">Blizzard</a>
        </section>
      ...
      <small>© 2026 Overwatch Heroes. Todos os direitos reservados.</small>
    </footer>
  );
}
